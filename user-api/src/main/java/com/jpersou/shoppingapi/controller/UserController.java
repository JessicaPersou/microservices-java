...
public class UserController {
    ...
    public UserDTO getUsersByDocumentAndKey(@RequestParam(name="key", required = true) String key,
    ...
    @GetMapping("/search")
    public List<UserDTO> queryByName(@RequestParam(name = "name", required = true, defaultValue = "") String name){
